...
export const TENNA_PARTY_THEME_COLLECTION_URI = `at://did:web:vessel.darkworld.download/${THEME_GROUP_COLLECTION}/3mv3iy7lipl22`
...
export const FEATURED_THEME_COLLECTION_URIS: Record<
  ...
  readonly string[]
> = {
  light: [FEATURED_THEME_COLLECTION_URI, BLUESKY_FORKS_THEME_COLLECTION_URI, TENNA_PARTY_THEME_COLLECTION_URI],
  dark: [FEATURED_THEME_COLLECTION_URI, BLUESKY_FORKS_THEME_COLLECTION_URI, TENNA_PARTY_THEME_COLLECTION_URI],
}
