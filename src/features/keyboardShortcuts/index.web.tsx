...
export function KeyboardShortcuts() {
  ...
  const clearSelection = useNonReactiveCallback((updateAnnouncement = true) => {
  ...
  const openSelectedPost = useNonReactiveCallback(() => {
  ...
  const restoreFeedSelection = useNonReactiveCallback(() => {
    clearTimeout(openedPostTimeoutRef.current)
  ...
  return (
    <>
      ...
      <View
        ...
        <Text>{enabled ? announcement : ''}</Text>
      </View>
    </>
  )
}
