...
func serve(cctx *cli.Context) error {
	...
	e.GET("/settings/runes", server.WebGenericNoindex)
	e.GET("/settings/runes/menus", server.WebGenericNoindex)
	e.GET("/settings/runes/badges", server.WebGenericNoindex)
	e.GET("/settings/runes/impressions", server.WebGenericNoindex)
	e.GET("/settings/runes/usability", server.WebGenericNoindex)
	e.GET("/settings/runes/display", server.WebGenericNoindex)
	e.GET("/settings/runes/infrastructure", server.WebGenericNoindex)
...
func (srv *Server) OAuthClientMetadata(c echo.Context) error {
	...
	metadata := map[string]interface{}{
		...
		"scope":                      "atproto transition:generic transition:email transition:chat.bsky space:*?authority=*&action=read_self",
