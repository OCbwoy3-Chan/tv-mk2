...
func serve(cctx *cli.Context) error {
	...
	e.GET("/settings/runes", server.WebGeneric)
	e.GET("/settings/runes/menus", server.WebGeneric)
	e.GET("/settings/runes/badges", server.WebGeneric)
	e.GET("/settings/runes/impressions", server.WebGeneric)
	e.GET("/settings/runes/usability", server.WebGeneric)
	e.GET("/settings/runes/display", server.WebGeneric)
	e.GET("/settings/runes/infrastructure", server.WebGeneric)
	e.GET("/settings/runes/other-additions", server.WebGeneric)
	e.GET("/settings/appearance", server.WebGeneric)
	e.GET("/settings/appearance/color-theme", server.WebGeneric)
	e.GET("/settings/ai-preferences", server.WebGeneric)
