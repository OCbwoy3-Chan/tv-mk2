...
const ratio = 512 / 512
const KAWAII_LOGO_RATIO = 1920 / 1080
const KAWAII_SMALL_LOGO_RATIO = 289 / 138
...
export const Logo = forwardRef(function LogoImpl(props: Props, ref) {
  ...
  if (logoVariant !== 'default') {
    ...
    const useLargeKawaiiLogo = !isJapanLogo && size > 100
    return (
      <Image
        source={
          isJapanLogo
        ...
        style={[
          {
            height: size,
            aspectRatio: isJapanLogo
              ? 2
              : useLargeKawaiiLogo
                ? KAWAII_LOGO_RATIO
                : KAWAII_SMALL_LOGO_RATIO,
          },
        ]}
      />
    )
