...
export const router = new Router<AllNavigatableRoutes>({
  ...
  DeltaSettings: '/settings/tv',
  DeltaBadgeSettings: '/settings/tv/badges',
  DeltaLabelSettings: '/settings/tv/labels',
  ...
  RunesUsabilityFeedSettings: '/settings/runes/usability/feeds',
