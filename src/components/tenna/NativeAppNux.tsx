    ...
    <Dialog.Outer
      ...
      <Dialog.ScrollableInner
          ...
          <View
            ...
            <View
              ...
              <Image
                ...
                source={require('../../../assets/tenna/native_app_announcement_nux.webp')}
                style={[
                  a.w_full,
                  {
                    aspectRatio: 333 / 104,
        ...
        <View style={[a.align_center, a.px_xl, a.pt_xl, a.gap_2xl, a.pb_sm]}>
          ...
          {IS_WEB && (
            <Button
              label={_(msg`Download`)}
              size="small"
              color="secondary"
              onPress={() => {
                void Linking.openURL("https://github.com/OCbwoy3-Chan/tv-mk2/actions")
              }}
              style={[a.w_full]}>
              <ButtonText>
