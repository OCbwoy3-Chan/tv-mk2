...
export const HELP_DESK_URL = `https://tangled.org/did:web:vessel.darkworld.download/tenna-party`
...
export const BSKY_APP_ACCOUNT_DID = 'did:web:vessel.darkworld.download'
...
export const NOTIF_SERVICE: Service = 'did:web:push.tenna.party#bsky_notif'
